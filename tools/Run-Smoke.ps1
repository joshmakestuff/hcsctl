...
#
# Default: a fresh, timestamped store under D:\tmp, full pull+import (the real gate, ~250 MB network).
...
param(
    [string]$Store = (Join-Path 'D:\tmp' "hcsctl-smoke-$(Get-Date -Format 'yyyyMMdd-HHmmss')"),
