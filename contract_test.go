...
var usageCases = []struct {
	...
	{"storage setup-base uvm without a UtilityVM", []string{"storage", "setup-base", "--layer", `C:\Windows`, "--uvm"}},
	{"storage setup-volume missing volume", []string{"storage", "setup-volume", "--layer", `C:\Windows`}},
	{"storage setup-volume missing layer", []string{"storage", "setup-volume", "--volume", `C:\Windows`}},
	{"storage setup-volume bad type", []string{"storage", "setup-volume", "--layer", `C:\Windows`, "--volume", `C:\Windows`, "--type", "wsl"}},
	{"storage setup-volume no such layer", []string{"storage", "setup-volume", "--layer", `C:\hcsctl-no-such-dir`, "--volume", `C:\Windows`}},
	...
	{"guest mount missing unc", []string{"guest", "mount", "--vmid", "00000000-0000-0000-0000-000000000000", "--path", "/mnt/x", "--credential", "hcsctl-files"}},
	{"guest mount missing path", []string{"guest", "mount", "--vmid", "00000000-0000-0000-0000-000000000000", "--unc", `\\h\s`, "--credential", "hcsctl-files"}},
	{"guest mount bad vmid", []string{"guest", "mount", "--vmid", "not-a-guid", "--unc", `\\h\s`, "--path", "/mnt/x", "--credential", "hcsctl-files"}},
	{"guest mount credential and user", []string{"guest", "mount", "--vmid", "00000000-0000-0000-0000-000000000000", "--unc", `\\h\s`, "--path", "/mnt/x", "--credential", "hcsctl-files", "--user", "u", "--password-stdin"}},
	{"guest mount user without password-stdin", []string{"guest", "mount", "--vmid", "00000000-0000-0000-0000-000000000000", "--unc", `\\h\s`, "--path", "/mnt/x", "--user", "u"}},
	{"guest mount no credential source", []string{"guest", "mount", "--vmid", "00000000-0000-0000-0000-000000000000", "--unc", `\\h\s`, "--path", "/mnt/x"}},
	{"guest unmount missing path", []string{"guest", "unmount", "--vmid", "00000000-0000-0000-0000-000000000000"}},
	{"files missing subcommand", []string{"files"}},
	{"files unknown subcommand", []string{"files", "frobnicate"}},
	{"files prepare missing network", []string{"files", "prepare"}},
	{"files prepare empty network", []string{"files", "prepare", "--network", ""}},
	{"files inspect stray argument", []string{"files", "inspect", "extra"}},
	{"files expose missing vmid", []string{"files", "expose", "--name", "data", "--source", `C:\Windows`}},
	{"files expose missing source", []string{"files", "expose", "--vmid", "00000000-0000-0000-0000-000000000000", "--name", "data"}},
	{"files expose name with separator", []string{"files", "expose", "--vmid", "00000000-0000-0000-0000-000000000000", "--name", `a\b`, "--source", `C:\Windows`}},
	{"files expose relative source", []string{"files", "expose", "--vmid", "00000000-0000-0000-0000-000000000000", "--name", "data", "--source", `relative\dir`}},
	{"files expose source not a directory", []string{"files", "expose", "--vmid", "00000000-0000-0000-0000-000000000000", "--name", "data", "--source", `C:\hcsctl-no-such-dir-xyz`}},
	{"files expose reserved label", []string{"files", "expose", "--vmid", "00000000-0000-0000-0000-000000000000", "--name", "data", "--source", `C:\Windows`, "--label", "vmId=x"}},
	{"files unexpose missing vmid", []string{"files", "unexpose", "--name", "data"}},
	{"files ls stray argument", []string{"files", "ls", "extra"}},
